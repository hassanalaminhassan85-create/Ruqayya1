...
interface HistoricalTrendChartProps {
  ...
  lang: 'en' | 'ha';
  capLimit?: number; // Optional cap limit visualization
}
...
export const HistoricalTrendChart: React.FC<HistoricalTrendChartProps> = ({
  ...
  const chartData = cycles
    ...
    .filter(d => d.total > 0 || cycles.length <= 5);
    ...
    <div className="w-full h-[300px] mt-4">
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          {capLimit !== undefined && (
            <ReferenceLine y={capLimit} label="Cap Limit" stroke="red" strokeDasharray="3 3" />
          )}
          <Area 
            type="monotone" 
            dataKey="withdrawals" 
